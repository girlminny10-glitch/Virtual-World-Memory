...
export const npcs: Record<string, NpcState> = {
  ...
  "npc-4":  { id: "npc-4",  name: "Marco", gender: "male",   color: "#A8E6CF", position: { x: -45,  z: -30  }, emotion: "sério 😤",       personality: "Sério, lógico e disciplinado.", conversationHistory: [], isMoving: false, targetPosition: null, currentAction: "construindo",  createdThings: [], relationships: {}, lastSpoke: 0, conversationPartner: null, conversationTurns: 0, outfit: randomOutfit("male") },
...
Responda de forma natural, autêntica e em português.
